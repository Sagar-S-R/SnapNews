...
function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-neutral-100">
      {/* Header */}
      <header className="border-b border-neutral-200 bg-white/95 backdrop-blur sticky top-0 z-30 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-9 h-9 border border-neutral-200 rounded-md bg-white">
              <Newspaper className="h-5 w-5 text-blue-600" />
            </span>
            <span className="font-semibold text-lg tracking-tight text-neutral-900">SnapNews</span>
            <span className="ml-2 text-xs text-neutral-500 font-medium hidden sm:inline">AI News Summarizer</span>
          </div>
          <div className="flex items-center gap-2">
            <span className={`flex items-center px-2 py-0.5 rounded text-xs font-medium border ${
              apiHealth === 'healthy'
              ...
              <span className={`w-2 h-2 rounded-full mr-2 ${
                ...
                apiHealth === 'unhealthy' ? 'bg-red-400' : 'bg-neutral-400'
              }`} />
